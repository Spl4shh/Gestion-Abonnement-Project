                        ...
                        try
                        {
                            ...
                            switch (numChoix)
                            {
                                case 1 :
                                {
                                    ...
                                    daoAbonnement.create(new Abonnement(dateDebutFormate, dateFinFormate, new Client(idClient), new Revue(idRevue)));
                                    break;
                                }
                                case 2 :
                                {
                                ...
                                case 3 :
                                {
                                    ...
                                    daoAbonnement.update(new Abonnement(id, dateDebutFormate, dateFinFormate, new Client(idClient), new Revue(idRevue)));
                                    break;
                                }
                                case 4 :
                                {
                        ...
                        try
                        {
                            ...
                            switch (numChoix)
                            {
                                case 1 :
                                {
                                    ...
                                    double tarifNumero = sc.nextDouble();
                                    sc.nextLine();
                                    ...
                                    daoRevue.create(new Revue(titre, description, tarifNumero, visuel, new Periodicite(idPeriodicite)));
                                    break;
                                }
                                case 2 :
                                {
                                ...
                                case 3 :
                                {
                                    ...
                                    daoRevue.update(new Revue(idRevue, titre, description, tarifNumero, visuel, new Periodicite(idPeriodicite)));
                                    break;
                                }
                                case 4 :
                                {
